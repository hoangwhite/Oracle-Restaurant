...
public class BillStatistic_Form extends javax.swing.JPanel {
    ...
    private void cmdExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdExcelActionPerformed
        ...
        try {
            ...
            workbook.easy_WriteXLSXFile(".\\src\\ExportFile_Excel\\BillList_" + simpleDateFormat.format(new Date()) + ".xlsx");
            File file=new File("src\\ExportFile_Excel\\BillList_" + simpleDateFormat.format(new Date()) + ".xlsx");
