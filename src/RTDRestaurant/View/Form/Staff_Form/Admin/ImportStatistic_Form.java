...
public class ImportStatistic_Form extends javax.swing.JPanel {
    ...
    public void init() {
        txtSearch.setHint("Find Receipt . . .");
    ...
    public void getCost() {
        try {
            txtprofit.setText(df.format(serviceA.getCostNK("Today")) + "đ");
    ...
    public void initTable() {
        try {
            list = serviceA.getListPNKIn("All");
    ...
    private void cmdExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdExcelActionPerformed
        ...
        try {
            ...
            workbook.easy_getSheetAt(0).setSheetName("Import Receipt List");
            ...
            workbook.easy_WriteXLSXFile(".\\src\\ExportFile_Excel\\ImportReceiptList_" + simpleDateFormat.format(new Date()) + ".xlsx");
            File file=new File("src\\ExportFile_Excel\\ImportReceiptList_" + simpleDateFormat.format(new Date()) + ".xlsx");
